...
//UC - 11
//11A
let totalWages = employeeDailyWageAndHoursArray.filter(dailyHoursAndWage => dailyHoursAndWage.dailyWage > 0)
                .reduce((totalWage, dailyHoursAndWage) => totalWage += dailyHoursAndWage.dailyWage, 0);

let totalHours = employeeDailyWageAndHoursArray.filter(dailyHoursAndWage => dailyHoursAndWage.dailyHours > 0)
...
//11C
let partTimeWorkingDaysStringArray = employeeDailyWageAndHoursArray.filter(dailyHoursAndWage => dailyHoursAndWage.dailyHours == 4).map(dailyHoursAndWage => dailyHoursAndWage.toString());
console.log("\n\nPart Time Working Days : " + partTimeWorkingDaysStringArray);

//11D
let nonWorkingDaysNumber = employeeDailyWageAndHoursArray.filter(dailyHoursAndWage => dailyHoursAndWage.dailyHours == 0).map(dailyHoursAndWage => dailyHoursAndWage.dayNumber);
